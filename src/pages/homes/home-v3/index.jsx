...
const metaInformation = {
  title: "Home v3 || flapabay - Real Estate ReactJS Template",
};
  ...
  return (
    <>
     <MetaData meta={metaInformation} />
      ...
      {/*People Love Living with Flapabay */}
          ...
          <div className="row align-items-md-center">
            ...
            >
              <div className="main-title">
                <h2 className="title">People Love Living with Flapabay</h2>
                <p className="paragraph">
                  Aliquam lacinia diam quis lacus euismod
                </p>
              </div>
      ...
      {/* End People Love Living with Flapabay */}
