...
const metaInformation = {
  title: "Contact  || Flapabay- Apartment Rental, Experiences and More!",
};
          ...
          <div className="row d-flex align-items-end">
            ...
            <div className="col-lg-5 offset-lg-2">
              ...
              <p className="text">
                ...
                corporates, Flapabayhas more than 9,000 offices of all sizes and
            ...
            >
              <div className="main-title text-center">
                ...
                <p className="paragraph">
                  Flapabayhas more than 9,000 offices of all sizes and all
