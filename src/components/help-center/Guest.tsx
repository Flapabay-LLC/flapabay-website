  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="p-4 border rounded-lg shadow-sm">
        ...
        <button className="mt-2 ">Go to Trips</button>
        <MdOutlineKeyboardArrowRight className=' text-lg mt-2' />
        </div>
      </div>
    </div>
    ...
    <h2 className="text-2xl font-medium pt-6 pb-2">Top articles</h2>
      <div className="grid grid-cols-2 pb-10 gap-4 text-sm">
        ...
        <a href="#" className=" underline font-medium">Find your reservation status as a guest</a>
        <p>Your reservation status keeps you updated on all kinds of things, such as whether you're...</p>
        </div>
        <div className='border-b pb-3 border-gray-300'>
        <a href="#" className=" underline font-medium">Deactivating or deleting your account</a>
        <p>We’d hate to see you go, but if you’ve decided to leave Airbnb, you have a couple of options....</p>
        </div>
        <div className='border-b pb-3 border-gray-300'>
        <a href="#" className=" underline font-medium">Instant Book</a>
        <p>Let’s connect! Make sure that the right people have your correct phone number. Hosts need...</p>
        </div>
        <div className='border-b pb-3 border-gray-300'>
        <a href="#" className=" underline font-medium">Setting up your account</a>
        <p>Want to book a place right away? Try searching for a place with Instant Book.</p>
        </div>
        <div    className='border-b pb-3 border-gray-300'>
        <a href="#" className=" underline font-medium">Verify your phone number</a>
        <p>You’ve logged in, but you need to edit your account. Where do you go? Here’s how to...</p>
        </div>
        <div   className='border-b pb-3 border-gray-300'>
        <a href="#" className=" underline font-medium">Editing a review you wrote</a>
        <p>
        To encourage honest and impartial reviews, we limit the ability of Hosts and guests to edit...</p>
        </div>
      </div>
