...
interface LoginModalProps {
  onClose: () => void;
  onPhoneSubmit?: (phone: string, code: string) => void;
  onEmailSubmit?: (email: string) => void;
}

const LoginModal: React.FC<LoginModalProps> = ({ onClose, onPhoneSubmit, onEmailSubmit }) => {
  ...
  const handlePhoneContinue = async () => {
    try {
      ...
      if (onPhoneSubmit) {
        onPhoneSubmit(phoneNumber, selectedCountryCode.replace('+', ''));
      } else {
